...
public class TeacherRequestLeave extends AppCompatActivity implements JsonResponse {
    ListView lv1;
    Button b1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_request_leave);
...
//
        ...
        JR.json_response=(JsonResponse) TeacherRequestLeave.this;
        String q = "/teacher_view_leave_request?login_id="+Login.logid;
        q=q.replace(" ","%20");
        JR.execute(q);
        ...
        e2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                datePickerDialog = new DatePickerDialog(TeacherRequestLeave.this,
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                else if(duration.equalsIgnoreCase(""))
                {
                    ...
                    JsonReq JR=new JsonReq();
                    JR.json_response=(JsonResponse) TeacherRequestLeave.this;
                    String q = "/teacher_send_leave_request?login_id="+Login.logid+"&reason="+reason+"&leave_date="+date+"&nodays="+duration;
                    q=q.replace(" ","%20");
                    JR.execute(q);
                }
            }
    ...
    public void response(JSONObject jo) {
        ...
        try {
            ...
            if(method.equalsIgnoreCase("teacher_view_leave_request")){
