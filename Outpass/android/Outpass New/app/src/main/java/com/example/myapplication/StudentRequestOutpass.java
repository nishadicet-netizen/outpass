...
public class StudentRequestOutpass extends AppCompatActivity implements JsonResponse, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_request_outpass);
...
//
        ...
        JR.json_response=(JsonResponse) StudentRequestOutpass.this;
        String q = "/student_view_outpass_request?login_id="+Login.logid;
        q=q.replace(" ","%20");
        JR.execute(q);
        ...
        e2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                datePickerDialog = new DatePickerDialog(StudentRequestOutpass.this,
        ...
        e3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(StudentRequestOutpass.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
...
//                        e2.setText(String.format("%02d:%02d", hourOfDay, minutes) + amPm);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                else if(time.equalsIgnoreCase(""))
                {
                    ...
                    JsonReq JR=new JsonReq();
                    JR.json_response=(JsonResponse)StudentRequestOutpass.this;
                    String q = "/student_send_outpass_request?login_id="+Login.logid+"&reason="+reason+"&date="+date+"&time="+time;
                    q=q.replace(" ","%20");
                    JR.execute(q);
                }
            }
    ...
    public void response(JSONObject jo) {
        ...
        try {
            ...
            if(method.equalsIgnoreCase("student_view_outpass_request")){
...
//                        Toast.makeText(getApplicationContext(),val[i], Toast.LENGTH_SHORT).show();
            ...
            if(method.equalsIgnoreCase("student_send_outpass_request"))
            {
                String status=jo.getString("status");
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        ...
        qrs=qr[arg2];
        if (statusss.equals("hod approved")) {


            final CharSequence[] items = {"View QR", "Cancel"};

            AlertDialog.Builder builder = new AlertDialog.Builder(StudentRequestOutpass.this);
            ...
            builder.setItems(items, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int item) {
                    if (items[item].equals("View QR")) {
                        ...
                        startActivity(new Intent(getApplicationContext(), StudentViewSanctionedQrForOutpass.class));
                    }
