...
public class MessPayment extends AppCompatActivity implements JsonResponse, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mess_payment);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (amount.equalsIgnoreCase("")) {
                    ...
                    JR.json_response = (JsonResponse) MessPayment.this;
                    String q = "/messpayment?amount=" + amount + "&rid=" + ViewMessAmount.req_id;
                    q = q.replace(" ", "%20");
                    JR.execute(q);
                }
            }
