...
MySQL - 5.5.5-10.1.38-MariaDB : Database - opass
*********************************************************************
*/
...
insert  into `student_rooms`(`student_room_id`,`student_id`,`room_id`,`assigned_date`,`status`) values (1,1,2,'2021-05-14','assigned'),(2,3,3,'2021-05-16','assigned'),(3,1,2,'2022-06-23','assigned'),(4,1,1,'2022-06-24','assigned');
...
insert  into `students`(`student_id`,`login_id`,`batch_id`,`course_id`,`first_name`,`last_name`,`house_name`,`place`,`parent_email`,`phone`,`email`,`hostel`) values (1,67,3,2,'anji','jose','UKKURU','thrissur','anjijose91@gmail.com','9847571534','anjijose91@gmail','Yes'),(2,68,1,1,'hj','b ','hhj','bjj','anjijose91@gmail.com','8767857675','anjijose91@gmail.com','Yes');
...
insert  into `teachers`(`teacher_id`,`login_id`,`hod_id`,`first_name`,`last_name`,`house_name`,`place`,`phone`,`email`) values (1,66,1,'Tintu','P B','erkl','manjali','8767676765','anjijose91@gmail.com');
